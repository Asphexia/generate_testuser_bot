...
TOKEN = '5935740849:AAFP11jY9JKBeQ1GCzRyTBwP8niPkoSKrHc'
...
def start_message_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        "Выбери, сколько пользователей нужно сгенерировать",
...
def message_handler(message: types.Message):
    ...
    if message.text == "1️⃣":
        ...
        bot.send_message(chat_id=message.chat.id, text="Введены некорректные данные. Нажмите на кнопку выбора или введите 1, 2, 5 или 10")
        return
